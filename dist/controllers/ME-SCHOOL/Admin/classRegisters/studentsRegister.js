...
exports.StudentsRegister = catchAsync_1.catchAsync((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const students = yield user_1.default.find({
        $and: [{ role: 'student', level: req.params.classId }],
    });
    const level = yield levelModel_1.default.findById(req.params.classId);
